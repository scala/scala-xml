...
class XMLTestJVM {
  ...
  lazy val parsedxml1 =
    XML.load(new InputSource(new StringReader("<hello><world/></hello>")))
  lazy val parsedxml11 =
    XML.load(new InputSource(new StringReader("<hello><world/></hello>")))
  val xmlFile2 =
    "<bib><book><author>Peter Buneman</author><author>Dan Suciu</author><title>Data on ze web</title></book><book><author>John Mitchell</author><title>Foundations of Programming Languages</title></book></bib>";
  ...
  def xpath = {
    ...
    assertTrue(
      parsedxml1 \ "world" sameElements List(Elem(null, "world", e, sc))
    )
  ...
  def xpathDESCENDANTS = {
    ...
    assertEquals(
      "<book><author>Peter Buneman</author><author>Dan Suciu</author><title>Data on ze web</title></book>",
      (parsedxml2 \\ "book") { (n: Node) =>
        (n \ "title") xml_== "Data on ze web"
      } toString
    )
  ...
  def unparsed = {
    ...
    val p = scala.xml.parsing.ConstructingParser
      .fromSource(scala.io.Source.fromString("<foo bar:attr='&amp;'/>"), true)
    val n = p.element(
      new scala.xml.NamespaceBinding("bar", "BAR", scala.xml.TopScope)
    )(0)
  ...
  def serializeComplex = {
    ...
    val people =
      new AddressBook(Person("Tom", 20), Person("Bob", 22), Person("James", 19))
  ...
  def t1620 = {
    val dt =
      DocType("foo", PublicID("-//Foo Corp//DTD 1.0//EN", "foo.dtd"), Seq())
...
<foo/>""",
  ...
  def t2771 = {
    ...
    def backslashSearch(x: xml.Elem) =
      "root:-" + (x \ "@{nsUri}at") + "-sub:-" + (x \ "sub" \ "@{nsUri}at") + "-"
  ...
  @UnitTest
  def t5115 = {
    def assertHonorsIterableContract(i: Iterable[_]) =
      assertEquals(i.size.toLong, i.iterator.size.toLong)
  ...
  def t5843 = {
    ...
    assertEquals(
      """ bar="2"""",
      bar remove (null, scala.xml.TopScope, "foo") toString
    )
    assertEquals(
      """ foo="1"""",
      bar remove (null, scala.xml.TopScope, "bar") toString
    )
  ...
  def t6939 = {
    val foo =
      <x:foo xmlns:x="http://foo.com/"><x:bar xmlns:x="http://bar.com/"><x:baz/></x:bar></x:foo>
    assertEquals(
      foo.child.head.scope.toString,
      """ xmlns:x="http://bar.com/""""
    )

    val fooDefault =
      <foo xmlns="http://foo.com/"><bar xmlns="http://bar.com/"><baz/></bar></foo>
    assertEquals(
      fooDefault.child.head.scope.toString,
      """ xmlns="http://bar.com/""""
    )
    ...
    assertEquals(
      foo2.child.head.scope.toString,
      """ xmlns:x="http://bar.com/""""
    )
    ...
    assertEquals(
      foo2Default.child.head.scope.toString,
      """ xmlns="http://bar.com/""""
    )
  }
  ...
  def t7074 = {
    ...
    assertEquals(
      """<a b="2" c="3" d="1"/>""",
      sort(<a d="1" b="2" c="3"/>) toString
    )
    assertEquals(
      """<a b="2" c="4" d="1" e="3" f="5"/>""",
      sort(<a d="1" b="2" e="3" c="4" f="5"/>) toString
    )
    assertEquals(
      """<a b="5" c="4" d="3" e="2" f="1"/>""",
      sort(<a f="1" e="2" d="3" c="4" b="5"/>) toString
    )
    assertEquals(
      """<a b="1" c="2" d="3" e="4" f="5"/>""",
      sort(<a b="1" c="2" d="3" e="4" f="5"/>) toString
    )
    assertEquals(
      """<a a:b="2" a:c="3" a:d="1"/>""",
      sort(<a a:d="1" a:b="2" a:c="3"/>) toString
    )
    assertEquals(
      """<a a:b="2" a:c="4" a:d="1" a:e="3" a:f="5"/>""",
      sort(<a a:d="1" a:b="2" a:e="3" a:c="4" a:f="5"/>) toString
    )
    assertEquals(
      """<a a:b="5" a:c="4" a:d="3" a:e="2" a:f="1"/>""",
      sort(<a a:f="1" a:e="2" a:d="3" a:c="4" a:b="5"/>) toString
    )
    assertEquals(
      """<a a:b="1" a:c="2" a:d="3" a:e="4" a:f="5"/>""",
      sort(<a a:b="1" a:c="2" a:d="3" a:e="4" a:f="5"/>) toString
    )
  }
  ...
  def attributes = {
    ...
    val xml1 = <t b="1" d="2"/>
    val xml2 = <t a={null: String} p:a={null: String} b="1" c={
      null: String
    } d="2"/>
    val xml3 = <t b="1" c={null: String} d="2" a={null: String} p:a={
      null: String
    }/>
    ...
    assertEquals(
      ...
      <t g="1" e="2" p:a="3" f:e="4" mgruhu:ji="5"/> toString
    )
  }
  ...
  def dontLoop: Unit = {
    val xml =
      "<!DOCTYPE xmeml SYSTEM 'uri'> <xmeml> <sequence> </sequence> </xmeml> "
    val sink = new PrintStream(new ByteArrayOutputStream())
    (Console withOut sink) {
      (Console withErr sink) {
        ConstructingParser
          .fromSource((io.Source fromString xml), true)
          .document()
          .docElem
      }
    }
  ...
  def issue17SecureProcessing: Unit = {
    assertTrue(
      defaultParserFactory.getFeature(
  ...
  def toSource(s: String) = new scala.io.Source {
    ...
    override def reportError(
        pos: Int,
        msg: String,
        out: java.io.PrintStream = Console.err
    ): Unit = {}
  }
  ...
  def xmlProcInstrTest: Unit = {
    ...
    assertEquals(
      new UnprefixedAttribute("aa", Text(""), Null),
      x.xmlProcInstr()
    )
  }
